...
#define STP_WRITE_REG                   14
#define STP_RESET                       15
#define STP_READ_REG                    16
...
#define STP_IOCX_WRITE_REG               _IOW(ALTERA_IOC_MAGIC, STP_WRITE_REG, struct stp_cmd)
#define STP_IOCX_READ_REG                _IOWR(ALTERA_IOC_MAGIC, STP_READ_REG, struct stp_cmd)
#define STP_IOCX_RESET                   _IO(ALTERA_IOC_MAGIC, STP_RESET)
